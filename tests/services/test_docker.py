...
def test_container_lifecycle(docker_service):
    ...
    try:
        ...
        found_container = docker_service.get_container(
        ...
        # Test force replace
        new_container = docker_service.run_container(
            container_config, force=True
        )
        ...
        assert any(
            c["name"] == container_config.container_name for c in containers
        )
